...
todos
  ...
  // This section helps you update a single document by id
  ...
  // This section also updates a single document by id
  ...
  // This section will help you delete a single document by id
  .delete("/:id", (req, res) => {
    let db_connect = dbo.getDB();
    let query = { _id: ObjectId(req.params.id) };
    db_connect
